...
export default function NewsSection() {
  ...
  const featured = {
    img: image1,
    title: "Spiritual and Enlightenment Hour at the International Agriculture University – with the Rector",
  ...
  const gridCards = [{
    id: 1,
    img: image2,
    title: "Strengthening University Governance through International Collaboration​",
    date: "4 February, 2026",
    views: "93"
  }, {
    id: 2,
    img: image3,
    title: " Enlightenment — the strongest shield against ignorance!​",
    date: "6 February, 2026",
    views: "112"
  }, {
    id: 3,
    img: image4,
    title: "A meaningful and useful master class was held at our university for senior students with the participation of Brian Kingswell, who visited from a foreign country.​",
    date: "8 February, 2026",
    views: "120"
  }, {
    id: 4,
    img: image5,
    title: "The intellectual game 'Zakovat' was held!",
    date: "3 February, 2026",
    views: "121"
  }];
  return <motion.section id="latest-news" className="newsx" variants={wrap} initial="hidden" whileInView="show" viewport={{
    once: true,
    amount: 0.2
  }}>
      <div className="newsx-container">
        ...
        <motion.div className="newsx-head" variants={fadeDown}>
          <h2 className="newsx-title">{t("university")}<span>{t("news")}</span>
          </h2>

          <Link to="/latest-news" className="newsx-more">{t("see_more")}<IoChevronForwardOutline />
          </Link>
        </motion.div>
        ...
        <div className="newsx-grid newsx-grid--noSide">
          ...
          <motion.div className="newsx-mid newsx-mid--wide" variants={wrap}>
            {gridCards.map((c, index) => <motion.article className="newsx-card" key={c.id} variants={index % 2 === 0 ? fadeRight // navbat bilan o‘ngdan
          : fadeUp // pastdan
          }>
