...
const PaperClipIconGradient = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="url(#gradient-partner)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="partner-link-icon">
          <defs>
...
export default function PartnersSection() {
  ...
  return <section className="partners-section">
               <div className="partners-container">
                    <h2 className="partners-title">{t("our")}<span className="text-teal">{t("partners")}</span>
                    </h2>

                    <div className="partners-slider-wrapper">
                         <Swiper modules={[Autoplay]} spaceBetween={30} slidesPerView={2} breakpoints={{
          560: {
            slidesPerView: 3
          },
          760: {
        ...
        }} loop={true} speed={5000} // makes it smooth and continuous
        autoplay={{
          delay: 0,
          disableOnInteraction: false,
          pauseOnMouseEnter: false
        }} allowTouchMove={false} className="partners-swiper">
                              {partnersData.map((item, index) => <SwiperSlide key={index}>
