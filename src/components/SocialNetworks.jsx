...
const SocialNetworks = () => {
  const networks = [{
    ...
    img: instagramImg,
    offset: '0px',
    url: 'https://www.instagram.com/iau_uz?igsh=MW1qeTZ5N3YyazhneA=='
  }, {
    name: 'Telegram',
    icon: <FaTelegramPlane />,
    img: telegramImg,
    offset: '-15px',
    url: 'https://t.me/iau_uz'
  }, {
    name: 'Facebook',
    icon: <FaFacebookF />,
    img: facebookImg,
    offset: '-25px',
    url: 'https://www.facebook.com/share/WND1PuA6C6xFT8mU/?mibextid=qi2Omg'
  }, {
    name: 'YouTube',
    icon: <FaYoutube />,
    img: youtubeImg,
    offset: '-15px',
    url: 'https://youtube.com/@iau_2022?si=wpViWkIgyDb5xzc-'
  }, {
    name: 'LinkedIn',
    icon: <FaLinkedinIn />,
    img: linkedinImg,
    offset: '0px',
    url: 'https://www.linkedin.com/school/international-agriculture-university/'
  }];
  return <section className="social-networks-section">
               {/* Background Icons (Faded Pattern) */}
               <div className="sn-bg-icons"></div>

               <div className="sn-container">
                    <div className="sn-text-content">
                         <h2 className="sn-title">{t("subscribe_to_our_pages")}<br />{t("on")}<span className="sn-highlight">{t("social_networks")}</span>
                         </h2>
                         <p className="sn-subtitle">{t("follow_the_latest_news_about_u")}</p>
                    </div>

                    <div className="sn-phones-wrapper">
                         {networks.map((net, idx) => <div key={idx} className="sn-phone-card">
                                   ...
                                   <div className="sn-button-overlay">
                                        <a href={net.url} target="_blank" rel="noopener noreferrer" className="sn-action-btn" style={{
              textDecoration: 'none'
            }}>
                                             {net.icon} {net.name}
                                        </a>
