...
const PaperClipIcon = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="useful-btn-icon">
...
const UsefulLinks = () => {
  ...
  const renderLogo = item => {
    ...
    if (item.type === "data") {
      return <div className="custom-logo data-logo">
  ...
  return <section className="useful-links-section">
      <h2 className="useful-section-title">{t("foydali_havolalar")}</h2>
      <div className="useful-container">
        <Swiper modules={[Autoplay]} spaceBetween={20} slidesPerView={1} loop={true} speed={4000} allowTouchMove={true} autoplay={{
        delay: 0,
