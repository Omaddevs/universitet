...
export default function ScientificCouncil() {
  ...
  return <div className="sc-page">
               <div className="sc-hero">
                    ...
                    <h1 className="sc-title">{t("the_members_of_the_scientific")}</h1>
               </div>
               ...
               <div className="sc-container">
                    <div className="sc-main">
                         ...
                         <div className="sc-tabs-container">
                              <div className="sc-tabs">
                                   <div className="sc-tab active">{t("all_members")}</div>
                              </div>
                         </div>

                         <div className="sc-list">
                              {members.map((member, idx) => <div key={idx} className={`sc-member-card ${member.imagePos === 'right' ? 'flex-row-reverse' : ''}`}>
                    ...
                    <aside className="sc-sidebar">
                         <div className="sc-sidebar-box">
                              <h4 className="sc-sidebar-title">{t("research")}</h4>
                              <ul className="sc-sidebar-menu">
                                   <li className="active"><a href="#">{t("iau_scientific_council_1")}</a></li>
                                   <li><a href="/research/gucae">{t("german_uzbek_chain_on_central")}</a></li>
                              </ul>
                         </div>
                    </aside>
               </div>
