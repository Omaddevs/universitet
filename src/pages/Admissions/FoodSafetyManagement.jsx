               ...
               <div className="admissions-hero">
                    ...
                    <div className="admissions-hero-content">
                         <div className="breadcrumbs">
                              ...
                              <span className="separator">&gt;</span>
                              <span className="current">{t("bsc__hons__food_safety_managem")}</span>
                         </div>
                         <h1>{t("bsc__hons__food_safety_managem")}</h1>
                    </div>
               </div>
                    ...
                    <div className="admissions-main">
                         ...
                         <div className="tab-content-box">
                              {activeTab === "courseContent" && <div className="content-pane fade-in">
                                        ...
                                        <p>{t("food_safety_is_a_major_area_of")}</p>
                                   </div>}
                              ...
                              {activeTab === "modules" && <div className="content-pane fade-in">
                                        ...
                                        <h3>{t("year_two")}</h3>
                                        <p>{t("u2031___food_science_and_techn")}<br></br>{t("u2017___practical_e__business")}<br></br>{t("u2011___introduction_to_resear")}<br></br>{t("u2004___personal_and_professio")}<br></br>{t("u2018___operations_management")}<br></br>{t("u2025___human_nutrition__healt")}<br></br>{t("u2026___people__food_and_socie")}<br></br>{t("u2027___food_safety_and_qualit")}<br></br>
                                        </p>
                                        <h3>{t("year_three")}</h3>
                                        <p>{t("u3004___research_project___dis")}<br></br>{t("u3016___international_business")}<br></br>{t("u3017___smart_food_systems")}<br></br>{t("u3024___food__ethics_and_gover")}<br></br>{t("u3025___inspiring_change_in_po")}<br></br>{t("u3026___poverty_and_food_secur")}<br></br>{t("u3027___facing_the_global_chal")}<br></br>
                                        </p>
                                        <h2>{t("careers_and_graduate_destinati")}</h2>
                                        <p>{t("upon_graduation__students_are_1")}<br></br><br></br>{t("you_could_progress_into_a_rang")}<br></br>{t("agricultural_policy")}<br></br>{t("farm_management")}<br></br>{t("enterprise_unit_operator_in_ag")}<br></br>{t("food_security_and_safety")}<br></br>{t("farm_business___agricultural_c")}<br></br>
                                        </p>
                                   </div>}

                              {activeTab === "entryRequirements" && <div className="content-pane fade-in">
                                        <h2>{t("entry_requirements")}</h2>
                                        <p>{t("students_completing_successful")}<br></br><br></br>{t("1__ielts_academic__ukvi_versio")}<br></br><br></br>{t("b1_level___cefr__common_europe")}<br></br>{t("85_90_scores_on_duolingo_engli")}<br></br>{t("please_note_that_university_of")}<br></br><br></br>{t("2__104_ucas_tariff_points_or_t")}<br></br><br></br>{t("successful_completion_of_year")}<br></br>{t("successful_completion_of_year_1")}<br></br>
                                        </p>
                                   </div>}
